/**
 * 2022/02/05
 * When I first created updating events I was just adding all the events and not checking if they included
 * prelims or not and also not skipping over early prelims
*/
